...
#define WIFI_SSID "DroMan_2.4"            // WIFI SSID here                                   
#define WIFI_PASSWORD "m#hzpmysz+?m"        // WIFI password here

// Declare global variables which will be uploaded to server

const char* serverName = "http://bmp280data.000webhostapp.com/write2database.php";
